...
public Cal() {
	...
	public int multiply(int n1 , int n2) {
		...
		System.out.println("여기는 부모클래스 메서드 입니다~");
		return n1 * n2;
	}
	// 코드 테스트 
...
class Cal2 extends Cal {
	public Cal2() {
		System.out.println("Cal2() 자식생성자 호출");
	}
	...
	// 오버라이드 처리한다. 부모를 안고치고 자식에서 덮어쓰기
//	public int multiply(int n1 , int n2) {
//		//a 또는 b --> 논리연산자 --> 논리합 || --> 둘중 하나라도 true 라면 -->true 이다
//		//a 그리고 b --> 논리연산자 --> 논리곱 --> 전부 true 여야 --> true 이다
//		if(n1 == 0 || n2 == 0) { // 둘중하나라도 0이라면
